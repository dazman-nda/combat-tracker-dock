...
export function registerSettings() {
    ...
    game.settings.register(MODULE_ID, "portraitHealthBar", {
        name: "combat-tracker-dock.settings.portraitHealthBar.name",
        hint: "combat-tracker-dock.settings.portraitHealthBar.hint",
        scope: "world",
        config: true,
        type: Boolean,
        default: true,
    ...
    game.settings.register(MODULE_ID, "portraitNegativeHealthMultiplier", {
        name: "combat-tracker-dock.settings.portraitNegativeHealthMultiplier.name",
        hint: "combat-tracker-dock.settings.portraitNegativeHealthMultiplier.hint",
        scope: "world",
        config: true,
        type: Number,
        choices: {
            5: "combat-tracker-dock.settings.portraitNegativeHealthMultiplier.choices.death",
            10: "combat-tracker-dock.settings.portraitNegativeHealthMultiplier.choices.destruction",
        },
        default: 5,
        onChange: () => ui.combatDock?.refresh(),
    });
